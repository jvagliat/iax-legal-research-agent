...
from iax_legal_lg_rag_research_agent.retrieval_graph.researcher_graph.graph import graph as researcher_graph
...
def route_query(
    ...
    if _type == "legal":
        ...
        # Manejo de errores: si el LLM devuelve algo inesperado, tratar como consulta general
        print(f"Warning: Router returned unknown type '{_type}', treating as 'general'")
        return "respond_to_general_query"
